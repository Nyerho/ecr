...
| 9. Notifications and community help | Add in-app notifications first, then push delivery and an explicitly documented SMS fallback; design jurisdiction-scoped emergency-help posts and moderated reply threads | N-01 through N-05; [community chat PRD addendum](./ECR-COMMUNITY-EMERGENCY-CHAT-PRD-ADDENDUM.md) | MVP planning; not implemented |
...
For the proposed community messaging requirements, see the [ECR Community Emergency Chat PRD Addendum](./ECR-COMMUNITY-EMERGENCY-CHAT-PRD-ADDENDUM.md). For an ordered gate-by-gate view of remaining work, see the [ECR Beta Readiness Checklist](./BETA-READINESS-CHECKLIST.md). Both the addendum and local photo picker describe planned/prototype behavior; neither provides a production-ready community channel or shared media store.
